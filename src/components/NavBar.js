        ...
        <div>
            <AppBar position="static">
                <Toolbar>
                    ...
                    <Typography style={{ paddingLeft: 10, fontSize: 20 }} variant="h7" color="fontSecondary">
                        Trip Monitor{" "}
                    </Typography>
            ...
            {isAuthenticated && (
                <AccountDetails open={openDetail} setOpen={setOpen} userID={user.email} onLogout={() => logout()} />
            )}
            {!isAuthenticated && (
                <AccountDetails
                    open={openDetail}
