    ...
    return (
        <div>
            <Paper style={styles.paperContainer}>
                <Paper style={{ backgroundColor: "rgba(255,255,255,0.5)", height: "70vh", paddingTop: "30vh" }}>
                    <Grid container alignItems="center" justify="center" direction="row" spacing={3}>
                        <Grid item>
                            <Typography variant="h1" xs={12} style={{ marginBottom: "20px", fontWeight: "bold" }}>
                                {" "}
                                Wildly{" "}
                            </Typography>
                        </Grid>
                        <Grid container alignItems="center" justify="center" direction="row" spacing={3}>
                            ...
                            >
                                <Grid item>
                                    {" "}
                                    <Button
                                        onClick={() => loginWithRedirect({ appState: { targetUrl: "/" } })}
                                        color="primary"
                                        variant="contained"
                                    >
                                        {" "}
